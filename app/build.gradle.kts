...
dependencies {
    ...
    implementation("com.github.navikt.tbd-libs:naisful-app:2025.05.26-17.31-d368ccc9")
    implementation("com.github.navikt.tbd-libs:kafka:2025.05.26-17.31-d368ccc9")
